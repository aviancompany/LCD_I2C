/*!
 * @file Avian_LiquidCrystal.h
 */
#ifndef Avian_LiquidCrystal_h
#define Avian_LiquidCrystal_h
 ...
 */
class Avian_LiquidCrystal : public Print {
public:
  /*!
   ...
   */
  Avian_LiquidCrystal(uint8_t rs, uint8_t enable, uint8_t d0, uint8_t d1,
   ...
   * @param d7 the data line 7
   */
  Avian_LiquidCrystal(uint8_t rs, uint8_t rw, uint8_t enable, uint8_t d0,
   ...
   */
  Avian_LiquidCrystal(uint8_t i2cAddr);
  /*!
   ...
   */
  Avian_LiquidCrystal(uint8_t data, uint8_t clock, uint8_t latch);
